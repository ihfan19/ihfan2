document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Welcome To Galery Ihfan" },
        { time: 3, text: "First Give Flower" },
        { time: 7, text: "Puncak" },
        { time: 12, text: "She So Cute" },
        { time: 16, text: "I Found You" },
        { time: 20, text: "She Make Me Happy" },
        { time: 25, text: "I See The Best In You" },
        { time: 29, text: "I Happy With Her" },
        { time: 33, text: "You are mine" },
        { time: 36, text: "And Im Yours" },
        { time: 43, text: "Im Yours" },
    ];
